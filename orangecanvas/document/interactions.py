...
def edit_links(
    ...
    dlg = EditLinksDialog(parent, windowTitle="编辑链接")
...
class EditNodeLinksAction(UserInteraction):
    ...
    def edit_links(self, initial_links=None):
        ...
        dlg = EditLinksDialog(self.document, windowTitle="编辑链接")
